<x-app-layout>
  <div class="relative min-h-screen overflow-auto max-w-screen text-wrap">
      <img src="{{ asset('https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1673&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D') }}" alt=""
