	...
	<x-card>
		<div class="flex flex-col space-y-4">
			...
			<div class="flex justify-end gap-4 ">
				...
				<x-button link="{{ route('leases.create') }}" class="max-w-xs text-white bg-green-400 border-green-400 btn-outline">
			...
			<x-my-modal :title="'Confirm Delete'" :listen="'delete-unit'" :clickAway="true">
				...
				<p class="text-lg font-bold">Unit ID: <span x-text="detail"></span></p>
