    ...
    <div class="grid grid-cols-5 space-x-5">
      ...
      <div class="col-span-2 p-5 bg-blue-100 rounded-2xl">
        ...
        <div class="py-2 ml-2 flex items-center">
          ...
          <p class=" font-light text-base pl-3 text-gray-500 uppercase"> ESTEBAN ABADA STREET, KATIPUNAN, QUEZON CITY KATIPUNAN, QUEZON CITY</p>
        </div>
      ...
      <div class="col-span-3 p-3 bg-blue-100 rounded-2xl">
        ...
        <div class="grid grid-cols-5 pt-3">
          <div class="col-span-2 p-3 ml-10 rounded-full overflow-hidden w-48 h-48 bg-gray-200 flex justify-center items-center">
            <img src="https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?q=80&w=1917&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Profile Picture" class="w-full h-full object-cover">
          </div>
