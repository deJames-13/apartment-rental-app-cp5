			...
			<div class="search-field">
				<div class="tabs-box">
					...
					<div class="tabs-content info-group">
						<div class="active-tab tab" id="tab-1">
							<div class="inner-box">
											...
											<div class="col-lg-4 col-md-12 col-sm-12 column">
												<div class="form-group">
													...
													<div class="field-input">
														...
														<input name="search-field" placeholder="Search by Property, Location or Landmark..." required=""
															type="search">
													</div>
												</div>
											</div>
											...
											<div class="row clearfix">
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													<div class="price-range">
														...
														<div class="range-input">
															<div class="input"><input class="property-amount" name="field-name" readonly="" type="text">
															</div>
														</div>
												...
												<div class="col-lg-6 col-md-6 col-sm-12 column">
													<div class="area-range">
														<h6>Select Area</h6>
														<div class="range-input">
															<div class="input"><input class="area-range" name="field-name" readonly="" type="text"></div>
														</div>
