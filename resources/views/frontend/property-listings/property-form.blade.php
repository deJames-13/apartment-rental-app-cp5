...
<div class="flex flex-col space-y-6 shadow-xl container bg-gray-200 mx-auto p-12 my-12 ">
	...
	<x-form wire:submit.prevent="{{ $form }}" method="post">
		...
		<div class="grid lg:grid-cols-3 gap-4">
			...
			<div class="col-span-2">
				<x-input type="text" class="input input-sm lg:input-md" label="Address" name="address" wire:model="address" />
			</div>
			...
			<div>
				<x-input type="file" accept="image/*" class="file-input file-input-bordered w-full max-w-xs"
